...
The Enterprise Technology Business Case Pack includes a full business case template, options analysis framework, financial model and delegate approval checklist. See the [templates page](https://lavelleptyltd.com.au/templates/business-case-pack) for details.
