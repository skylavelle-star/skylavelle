...
The Project Recovery Pack includes structured templates for health assessment, stakeholder reset communications, recovery roadmap planning and risk re-baselining. See the [templates page](https://lavelleptyltd.com.au/templates/project-recovery-pack) for details.
