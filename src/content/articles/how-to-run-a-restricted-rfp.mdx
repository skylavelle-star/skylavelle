...
The Procurement Evaluation Pack includes a weighted evaluation scorecard, evaluator guidance, probity checklist, BAFO request template and recommendation report structure. See the [templates page](/templates/procurement-evaluation-pack) for details.
