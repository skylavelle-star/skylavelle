...
The Steering Committee Reporting Pack includes a status report template, executive dashboard format, risk register structure, RAG rating criteria guide and escalation pack template. See the [templates page](/templates/steering-committee-reporting-pack) for details.
